        ...
        (c
            ...
            : e !== a &&
              (void 0 === $jscomp.propertyToPolyfillSymbol[d] &&
                  ((a = (1e9 * Math.random()) >>> 0),
                  ($jscomp.propertyToPolyfillSymbol[d] =
                      $jscomp.IS_SYMBOL_NATIVE
...
$jscomp.asyncExecutePromiseGenerator = function (c) {
    ...
    return new Promise(function (b, d) {
        function f(g) {
            g.done
                ? b(g.value)
                : Promise.resolve(g.value).then(e, a).then(f, d);
        }
        f(c.next());
    });
};
    ...
    class c {
        constructor(a, b, d, f, g) {
            ...
            document.body.contains(a) ||
                (document.body.appendChild(a), (k = !0));
            d = a.parentElement;
            ...
            return $jscomp.asyncExecutePromiseGeneratorFunction(function* () {
                ...
                try {
                    if (a.$video.srcObject) {
                        if (!(a.$video.srcObject instanceof MediaStream))
                            return !1;
                        b = a.$video.srcObject;
        ...
        turnFlashOff() {
            ...
            return $jscomp.asyncExecutePromiseGeneratorFunction(function* () {
                a._flashOn &&
                    ((a._flashOn = !1), yield a._restartVideoStream());
            });
        }
        destroy() {
            ...
            return $jscomp.asyncExecutePromiseGeneratorFunction(function* () {
                ...
                if (!a._active || a._paused)
                    if (
                        ...
                        if (((a._paused = !1), a.$video.srcObject))
                            yield a.$video.play();
                        else
                            try {
                                let { stream: b, facingMode: d } =
                                    yield a._getCameraStream();
                                !a._active || a._paused
                                    ? c._stopVideoStream(b)
                                    : (a._setVideoMirror(d),
                                      (a.$video.srcObject = b),
                ...
                try {
                    ...
                    if (d instanceof Worker) {
                        ...
                        n = yield new Promise((t, z) => {
                            ...
                            y = c._postWorkerMessageSync(h, "decode", A, [
                                A.data.buffer,
                            ]);
                        });
                    } else
            ...
            return $jscomp.asyncExecutePromiseGeneratorFunction(function* () {
                ...
                if (
                    !(
                        ...
                        (yield BarcodeDetector.getSupportedFormats()).includes(
                            "qr_code"
                        )
                    )
                )
        ...
        static _convertPoints(a, b) {
            ...
            let d = b.x || 0,
                f = b.y || 0,
                g =
                    b.width && b.downScaledWidth
                        ? b.width / b.downScaledWidth
                        : 1;
            b =
                b.height && b.downScaledHeight
                    ? b.height / b.downScaledHeight
                    : 1;
                    ...
                    return $jscomp.asyncExecutePromiseGeneratorFunction(
                        function* () {
                            if (!(1 >= a.$video.readyState)) {
                                ...
                                !c._disableBarcodeDetector ||
                                    (yield a._qrEnginePromise) instanceof
                                        Worker ||
